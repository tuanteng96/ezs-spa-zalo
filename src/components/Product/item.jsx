  ...
  return (
    <NavLink to={`/catalogue/${product.id}`} className="bg-white">
      ...
      <div className="p-2">
        ...
        <PriceSale Price={product.price} PriceSale={product.pricesale} SaleBegin={product.source.SaleBegin} SaleEnd={product.source.SaleEnd} IsDisplayPrice={product.IsDisplayPrice} />
      </div>
    </NavLink>
  );
};