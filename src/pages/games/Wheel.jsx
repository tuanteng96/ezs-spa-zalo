...
const WheelPage = () => {
  ...
  const audioRef = useRef(
    typeof Audio !== "undefined"
      ? new Audio(
        toAbsolutePathAPI("/brand/minigame/assets/mp3/backgroundsound.mp3")
      )
      : null
  );
  const winerSound = useRef(
    new Audio(toAbsolutePathAPI("/brand/minigame/assets/mp3/fanfare-winner.mp3"))
  );
    ...
    queryFn: async () => {
      ...
      if (!rs) {
        let { data } = await axios.get(
          toAbsolutePath("/brand/minigame/assets/json/prize.json")
        );
      ...
      <>
        <div className="navbar fixed top-0 left-0 min-w-[100vw] max-w-[100vw] z-[999] bg-white">
          <div className="w-2/3 relative flex items-center h-full pl-10">
            ...
            <Text.Title className="text-app">Vòng quay may mắn</Text.Title>
          </div>
        </div>
        <div className="h-full pt-12">
          <div
            ...
            style={{
              "--color-bg": data?.color || "#d51e1e",
              background: `url(${toAbsolutePathAPI(
          ...
          >
            ...
            >
              <div className="relative">
                ...
                >
                  <img
                    src={toAbsolutePathAPI("/brand/minigame/assets/12/vongquay.png")}
                    alt=""
                  />
                </div>
                <div
                ...
                >
                  <img
                    className="w-full"
                    src={toAbsolutePathAPI("/brand/minigame/assets/12/quay.png")}
                    alt=""
                  />
                </div>
                <div
                ...
                >
                  <img
                    className="w-full"
                    src={toAbsolutePathAPI("/brand/minigame/assets/12/muiten.png")}
                    alt=""
                  />
                </div>
              </div>
              ...
              >
                ...
                >
                  <img
                    ...
                    src={toAbsolutePathAPI("/brand/minigame/assets/12/TITLE.png")}
                    alt=""
                  />
                </div>
                <div className="mb-5">
                ...
                {!data?.unlimitedTurns && (
                  <div className="text-center mb-[5px]">
                    Khách hàng có
                    <span className="px-[5px] font-medium">{data?.contact ? "0" : "1"}</span>
                    lượt quay.
                  </div>
                )}
                <PrizePicker data={data?.data || []}>
                  {({ open }) => (
                    <div className="underline fw-meidum" onClick={open}>
