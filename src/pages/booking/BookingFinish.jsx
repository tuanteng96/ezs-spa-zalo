  ...
  return (
    <div className="h-full">
      ...
      >
        ...
        <g transform="matrix(.335245 0 0 0.335245 59.198993-200.565152)">
          ...
          <g>
            ...
            <g id="e9Yjp3XycKs25_to" transform="translate(780.484985,532.785019)">
            ...
            <g>
              ...
              >
                <g transform="translate(-967.42,-966.000001)">
                  <path
                    ...
                    fill="#1c2747"
                  />
                  <path d="M967.42,966c0,0,9.86-47.32,49-75.74Z" fill="#0559e8" />
                </g>
              </g>
              <g id="e9Yjp3XycKs47_tr" transform="translate(920.35,965.58) rotate(0)">
              ...
              >
                <g transform="translate(-920.16,-965.579999)">
                  ...
                  <path
                    ...
                    fill="#1c2747"
                  />
                  <path d="M920.18,873c0,0-26.12-67.65,0-135.29Z" fill="#0559e8" />
                </g>
              </g>
              <g
                id="e9Yjp3XycKs55_tr"
              ...
              >
                <g transform="translate(-902,-966)">
                  <path
                    ...
                    fill="#1c2747"
                  />
                  <path d="M902,966c0,0-46.88-83.53-25.45-176.89Z" fill="#0559e8" />
                </g>
              </g>
              <g id="e9Yjp3XycKs58_tr" transform="translate(833.34,965.58) rotate(0)">
              ...
              >
                <g transform="translate(-819.29,-965.67)">
                  ...
                  <path
                    ...
                    fill="#1c2747"
                  />
                  <path d="M819.29,876.41c0,0-21.51-55.73,0-111.45Z" fill="#0559e8" />
                </g>
              </g>
              <g id="e9Yjp3XycKs65_tr" transform="translate(819.29,965.58) rotate(0)">
              ...
              >
                <g transform="translate(-785.47,-966.000001)">
                  <path
                    ...
                    fill="#0559e8"
                  />
                  <path d="M785.47,966c0,0-14.81-50.52-59.73-78Z" fill="#1c2747" />
                </g>
              </g>
              <g id="e9Yjp3XycKs71_to" transform="translate(1033.089966,946.799988)">
                <circle
                  r="6.11"
              ...
              <g id="e9Yjp3XycKs72_to" transform="translate(967.369995,890.650024)">
                <circle
                  r="6.11"
              ...
              <g id="e9Yjp3XycKs73_to" transform="translate(864.23999,946.799988)">
                <circle
                  r="6.11"
              ...
              <g id="e9Yjp3XycKs74_to" transform="translate(785.859985,810.369995)">
                <circle
                  r="6.11"
              ...
              <g id="e9Yjp3XycKs75_to" transform="translate(695.380005,946.799988)">
                <circle
                  r="6.11"
          ...
          <g mask="url(#e9Yjp3XycKs81)">
            <g id="e9Yjp3XycKs80_to" transform="translate(553.532547,498.211393)">
      ...
      <div className="text-center px-5">
        <div className="font-bold text-lg mb-2">"Đặt lịch" thành công rồi nhé.</div>
        <div>Chúng tôi sẽ sớm liên hệ lại cho bạn để nhận đặt lịch. Bạn vui lòng chờ ... </div>
      </div>
      <div className="flex items-center flex-col mt-10">
        <NavLink className="bg-app text-white w-[180px] text-center py-3.5 rounded shadow-3xl font-medium" to="/user/customer-booking-manage">
          Quản lý đặt lịch
        </NavLink>
        <div className="border-app text-app border w-[180px] text-center py-3.5 rounded mt-2.5 shadow-3xl font-medium" onClick={() => {
          navigate({
            pathname: "/booking",
            options: {
              state: null
