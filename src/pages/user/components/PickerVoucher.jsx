    ...
    <>
      ...
      {createPortal(
        <Sheet visible={visible} onClose={() => setVisible(false)} autoHeight>
          <div>
            <div className="text-lg font-bold p-3 border-b border-b-4">
              Mã Code <span className="text-app pl-1">{item.ma}</span>
            </div>
            <div className="relative">
              <div className="border-b p-3 last:border-0">
                <div className="text-muted mb-1">Ngày bắt đầu - Hạn sử dụng</div>
              ...
              <div className="border-b p-3 last:border-0">
                <div className="text-muted mb-1">Số lần sử dụng / Tổng số lần</div>
                <div className="font-medium">
                  {item.gioi_han_so_lan_su_dung === -1 ? (
                    `${item.so_lan_su_dung} / Không giới hạn`
                  ) : (
                    <>
                      {Number(item.gioi_han_so_lan_su_dung) <= Number(item.so_lan_su_dung)
                        ? "Hết lượt sử dụng"
              ...
              </div>
              {
                item.so_luong_mua_tung_don > 0 && (
                  <div className="border-b p-3 last:border-0">
                    <div className="text-muted mb-1">Giới hạn số lượng SP / DV trên cả đơn hàng</div>
                    <div className="font-medium">
              ...
              }
              {
                item.so_luong_mua_tung_san_pham > 0 && (
                  <div className="border-b p-3 last:border-0">
                    <div className="text-muted mb-1">Giới hạn số lượng trên từng SP / DV</div>
                    <div className="font-medium">
              ...
              }
              {
                item.aff && (
                  <div className="border-b p-3 last:border-0">
                    <div className="text-muted mb-1">Mã dùng chia sẻ cho bạn bè</div>
                    <div className="font-medium">
