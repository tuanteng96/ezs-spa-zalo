...
const CustomerVoucher = () => {
  ...
  return (
    <Page className="page !pb-0" hideScrollbar>
      ...
      <div className="p-3">
        {
          isLoading && Array(3).fill(3).map((_, index) => (
            <div
            ...
            <>
              {
                !data || data.length === 0 && (
                  <div className="flex flex-col items-center px-5 py-12">
                    ...
                    <div className="font-bold text-lg mb-px">"Hổng" có mã giảm giá nào ?</div>
                    <div className="text-center">Hãy bắt đầu săn mã giảm giảm giá từ các chương trình ...</div>
                  </div>
                )
              }
              {
                        ...
                        >
                          ...
                          <div className="px-3 py-2.5 flex-1">
                            ...
                            <div className="flex mt-2 justify-between">
                              ...
                              <div className="uppercase font-bold text-[13px] text-primary">Chi tiết</div>
                            </div>
                          </div>
                        </div>
                      )
