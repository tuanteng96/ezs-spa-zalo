  ...
  return (
    <Page className="page !pb-safe-bottom" hideScrollbar>
      ...
      <div className="h-full flex flex-col">
        <PullToRefresh className="ezs-ptr grow" onRefresh={refetch}>
        ...
        <div className="p-4">
          <Link className="bg-app text-white rounded-[30px] h-12 flex items-center justify-center" to="/user/customer-voucher-change">Đổi mã quà tặng</Link>
        </div>
      </div>
    </Page>
  );
