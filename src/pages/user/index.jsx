    ...
    <Page className="page" hideScrollbar>
      <div className="navbar fixed top-0 left-0 min-w-[100vw] max-w-[100vw] z-[999] transition px-3 bg-app">
        <div className="w-2/3 relative flex items-center h-full">
          <Text.Title
            className="text-white truncate transition"
          >
            Hồ sơ
          </Text.Title>
        </div>
      ...
      <NavLink to="/" className="bg-white p-3 flex items-center">
        <div className="w-12">
          <img className="shadow-3xl rounded-full w-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" />
        </div>
        <div className="pl-3 flex-1">
          <div className="text-[16px] font-medium leading-6">Nguyễn Tài Tuấn</div>
      ...
      <div className="bg-white mt-2">
        ...
        <NavLink to="/" className="flex px-3 py-4 items-center">
          <div className="text-app">
            <Icon icon="zi-heart" />
          </div>
      ...
      <div className="bg-white mt-2">
          ...
          <div className="flex-1 pl-3">
            <div className="flex items-center justify-between relative before:content-[''] before:absolute before:w-full before:h-[1px] before:bg-[#f5f5fa] before:-bottom-4">
              <div>
                ...
                <div className="text-muted text-[14px]">Quản lý ví & thẻ tiền của bạn</div>
              </div>
              <div className="text-muted">
                <Icon icon="zi-chevron-right" />
              </div>
        ...
        <NavLink to="/user/customer-diary" className="px-3 py-4 flex items-center">
          <div className="w-7">
          ...
          <div className="flex-1 pl-3">
            <div className="flex items-center justify-between relative before:content-[''] before:absolute before:w-full before:h-[1px] before:bg-[#f5f5fa] before:-bottom-4">
              <div>
                ...
                <div className="text-muted text-[14px]">Lưu trữ các nhật ký của bạn</div>
              </div>
              <div className="text-muted">
                <Icon icon="zi-chevron-right" />
              </div>
        ...
        <NavLink to="/user/customer-orders" className="px-3 py-4 flex items-center">
          <div className="w-7">
          ...
          <div className="flex-1 pl-3">
            <div className="flex items-center justify-between relative before:content-[''] before:absolute before:w-full before:h-[1px] before:bg-[#f5f5fa] before:-bottom-4">
              <div>
                ...
                <div className="text-muted text-[14px]">Quản lý đơn hàng của bạn</div>
              </div>
              <div className="text-muted">
                <Icon icon="zi-chevron-right" />
              </div>
        ...
        <NavLink to="/user/customer-voucher" className="px-3 py-4 flex items-center">
          <div className="w-7">
          ...
          <div className="flex-1 pl-3">
            <div className="flex items-center justify-between relative">
              <div>
                ...
                <div className="text-muted text-[14px]">Kho mã giảm giá bạn đang có</div>
              </div>
              <div className="text-muted">
                <Icon icon="zi-chevron-right" />
              </div>
